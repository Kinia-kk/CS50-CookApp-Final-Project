...
# (str) Package name
package.name = cookapp

# (str) Package domain (needed for android/ios packaging)
package.domain = org.kinga
...
requirements = python3,kivy,sqlite3,kivymd,android
...
presplash.filename = %(source.dir)s/CookApp.png

# (str) Icon of the application
icon.filename = %(source.dir)s/CookApp.png
...
android.permissions = android.permission.INTERNET, android.permission.READ_EXTERNAL_STORAGE, android.permission.WRITE_EXTERNAL_STORAGE #(name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
